                ...
                @php
                    $clientLogos = [
                        [
                            ...
                            'class' => 'h-28 md:h-48 brightness-0 opacity-50 hover:opacity-100 scale-125'
                        ],
                        [
                            'src' => asset('images/mitra/hamosa_picture.png'),
                            'class' => 'h-24 md:h-36 brightness-0 opacity-50 hover:opacity-100'
                        ],
                        [
                        ...
                        [
                            ...
                            'class' => 'h-24 md:h-36 mix-blend-multiply grayscale opacity-60 hover:opacity-100'
                        ],
                    ];
                @endphp
            ...
            <div class="reveal grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                ...
                <div class="portfolio-featured md:col-span-2 cursor-zoom-in group h-64 md:h-[460px]" data-cat="Wedding"
                    ...
                    <div
                        ...
                        <span
                            class="text-red-400 text-[10px] font-bold tracking-widest uppercase mb-1">Prewedding</span>
